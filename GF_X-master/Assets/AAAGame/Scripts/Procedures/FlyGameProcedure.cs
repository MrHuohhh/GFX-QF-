...
public class FlyGameProcedure : ProcedureBase
{
    int menuUIFormId;
    int levelEntityId;
    FlyLevelEntity lvEntity;
    ...
    protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
    {
        ...
        //Log.Info(Utility.Converter.GetString(res.Bytes));TestssssTable

        var tastTb = GF.DataTable.GetDataTable<TestssssTable>();
        var tastTb2 = GF.DataTable.GetDataTable<Test2Table>();
        GF.LogInfo(tastTb.GetDataRow(1).EnumP);

        var uiparam = UIParams.Create();
        uiparam.OpenCallback = OnTestDialog;
        uiparam.Set<VarInt32>("Value",999);
        GF.UI.OpenUIForm(UIViews.UITestD,uiparam);
    }
    
    private void OnTestDialog(UIFormLogic obj)
    {
        Log.Info("打开了界面");
    }
    ...
    public void EnterGame()
    {
        ...
        ChangeState<FlyStartGameProcedure>(procedure);
    }
    public void ShowLevel()
    {
        ...
        levelEntityId = GF.Entity.ShowEntity<FlyLevelEntity>("FlyLv", Const.EntityGroup.Level, lvParams);
    }
    ...
    private void OnShowEntitySuccess(object sender, GameEventArgs e)
    {
        ...
        {
            lvEntity = args.Entity.Logic as FlyLevelEntity;
