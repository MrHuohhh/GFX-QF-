...
public class FlyStartGameProcedure : ProcedureBase
{
    public GameUIForm GameUI { get; private set; }
    public FlyLevelEntity Level { get; private set; }
    ...
    protected override void OnEnter(IFsm<IProcedureManager> procedureOwner)
    {
        ...
        Level = procedureOwner.GetData<VarUnityObject>("LevelEntity").Value as FlyLevelEntity;
